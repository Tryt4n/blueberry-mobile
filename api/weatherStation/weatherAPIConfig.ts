const weatherConfig = {
  appKey: process.env.EXPO_PUBLIC_WEATHER_APP_KEY,
  apiKey: process.env.EXPO_PUBLIC_WEATHER_API_KEY,
  weatherStationMacAddress: process.env.EXPO_PUBLIC_WEATHER_STATION_MAC_ADDRESS,
  forecastApiKey: process.env.EXPO_PUBLIC_FORECAST_API_KEY,
